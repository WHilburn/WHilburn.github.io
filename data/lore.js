CONTENT.lore = {
  ...
  "knownLore": {
    ...
    "intro": "Facts that any Awakened citizen, regardless of nation, would recognize without needing a scholar to explain it.",
    "list": [
      {
        "enabled": true,
        "icon": "❇️",
        ...
        "paragraphs": [
          "Every child in every nation learns the same basic tale: once, the world belonged to the Smooth Ones, and animals were all Silent. Then, in a event that no living person remembers, the Smooth Ones were gone and the animals were not silent anymore. Many animals stood upright, spoke their first words, and started building the world that exists today from the ruins of the Smooth Ones.",
          "Nations and scholars disagree fiercely about what it meant, who caused it, and which god deserves the credit. Almost no Awakened disagree that it happened, but no consensus exists on the specifics of the event."
        ]
      },
      {
        "enabled": true,
      ...
      },
      {
        ...
        "icon": "🍖",
        "iconBg": "#1a1508",
        "title": "Eating the Silent",
        "teaser": "Canibalism or fair game?",
        "status": "Fact of life",
        "paragraphs": [
          "Food sources are a contentious topic among all of Everden, and one of the largest sources of division between species. Herbivorous people like horsefolk and birdfolk are happy to enjoy a meal of greens and seeds, but sharing a table with omnivorous species often leads to conflict, leading many vegetarians to avoid associating with meat-eating species.",
          "Silent animals are hunted and bred as livestock for their meat and other products in most nations. Most people would never eat animal meat from a silent version of their own species. Whiskerburrow, with the highest percentage of vegetarian folks, has a few no-kill ranches where cows and chickens are treated gently their entire lives, only taking milk and eggs."
        ]
      }
    ]
  },
  "mysteries": {
    ...
    "intro": "Everden's loose threads: things that are widely believed, disputed, or completely unexplained.",
    "list": [
      {
        "enabled": true,
        "icon": "🐉",
        "iconBg": "#14101c",
        "title": "Mysteries of the Dragons",
        "teaser": "Potential bringers of ruin, or just big lizards?",
        "status": "Source of speculation",
        "paragraphs": [
          "Dragons are known to exist in Everden. They have been spotted at the far edges of Everden in places people do not often go, but two are permanent residents of Sunreach. Eggyt, dragon of the desert, rests lazily upon a stone momument in the desert, accepting offerings made by those with the courage to approach, but seemingly having no patience for people who want to talk or study it. Yggdros lords over the city of Scalemoor, accepting offerings of food from inhabitants, and residents claim that the only reason it hasn't wiped the city off the map is because of people's reverance for it. Nobody has ever gotten the dragons to speak to them, or know if the dragons can understand them.",
          "Many adventurers have made claims of encountering dragons deep within smooth one ruins, or caves, or in storms out at sea. These stories often end with the teller either barely making it out alive, or having slain the fearsome foe. Neither type of story ever seems to have any kind of concrete proof that can be shared.",
          "Many Sunreach scholars have claimed that there is a connection between lizardfolk and dragons, noting similarities in their physical attributes. Some even believe there is a direct relationship between dragons and lizardfolk, as there is a relationship between lizardfolk and silent lizards."
        ]
      },
      {
        "enabled": true,
